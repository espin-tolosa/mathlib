...
/*
 * Low-level addressing of floating point is designed to target little-endian CPUs
 * reversing these values would contribute to target big-endian CPUs, but other changes
 * might be needed.
 */
...
/*
 * Bit layout in little endian (target)
 * |SEEEEEEEEEEEMMMM|MMMMMMMMMMMMMMMM|MMMMMMMMMMMMMMMM|MMMMMMMMMMMMMMMM|
 * |    16  bits    |    16  bits    |    16  bits    |    16  bits    |
 * |    W0 = 3      |    W1 = 2      |    W2 = 1      |    W3 = 0      |
 */
