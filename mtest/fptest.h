...
#define TEST_ASSERT_EQUAL_FP64(a,b) do{if(!fp64_equals((a),(b))) { fprintf(stderr, "[ASSERTION FAILED] expect: %+.15e, given: %+.15e, at line:%d\n", (a),(b),__LINE__); ++m_ntest_failed; }}while(0)
